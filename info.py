...
# Bot information
SESSION = environ.get('SESSION', 'MasterMind Cine Robot')
API_ID = int(environ.get('API_ID',34431604 ''))
API_HASH = environ.get('API_HASH',8c6e35df8dd50e13eaa197d04658f238 '')
BOT_TOKEN = environ.get('BOT_TOKEN', 8525698282:AAHOrYmvV9_M-o9PTHH78LhTxmxUhG6L-Ic"")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', 6704807153 '').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', 6704807153 '').split()]  # For Multiple Id Use One Space Between Each.
AUTH_USERS = (auth_users + ADMINS) if auth_users else [6704807153]

# This Channel Is For When User Start Your Bot Then Bot Send That User Name And Id In This Log Channel, Same For Group Also.
LOG_CHANNEL = int(environ.get('LOG_CHANNEL',- -1003733732994 ''))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', -1003651246632'').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL',-1003406202975 '') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', -1003838926045'')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None

# This Channel Is For Index Request 
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL'-1003850648357, LOG_CHANNEL))

# This Is Your Bot Support Group Id , Here Bot Will Not Give File Because This Is Support Group.
support_chat_id = environ.get('SUPPORT_CHAT_ID', -1003722450662'')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

# This Channel Is For /batch command file store.
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', -1003797683209'')).split()]  # For Multiple Id Use One Space Between Each.
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS',-1003885077847 '0').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI',mongodb+srv://s35903420_db_user:aF38jugKqpMTY8vR@cluster0.bayytzy.mongodb.net/?appName=Cluster0"")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', https://t.me/MasterMind_Cine_Group'')
CHNL_LNK = environ.get('CHNL_LNK',https://t.me/MasterMind_Cinemas '')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/MasterMind_Cine_Group') # Support Chat Link Without https:// or @
